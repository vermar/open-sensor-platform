...
#if defined ON_DEMAND_PROFILING && defined ASF_PROFILING //'\r' input on serial port causes profiling to be displayed
            if (inByte == TOKEN_STATS)
            {
                return true;
            }
#endif
