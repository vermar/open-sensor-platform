...
ASF_TASK_STATIC (TCPIP_TASK_ID,         tcpip_thread,       osPriorityNormal,       (0x400+STACK_INCREASE),  4)
ASF_TASK_STATIC (DHCP_TASK_ID,          DHCP_thread,        osPriorityBelowNormal,  (0x400+STACK_INCREASE),  4)
ASF_TASK_STATIC (HTTPS_TASK_ID,         https_server,       osPriorityAboveNormal,  (0x800+STACK_INCREASE),  4)
ASF_TASK_STATIC (ETHINPUT_TASK_ID,      ethernetif_input,   osPriorityRealtime,     (0x400+STACK_INCREASE),  4)
