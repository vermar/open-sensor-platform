...
static void low_level_init(struct netif *netif)
{
  ...
  //osThreadDef(ethernetif_input, osPriorityRealtime, 0, INTERFACE_THREAD_STACK_SIZE);
  //osThreadCreate (osThread(ethernetif_input), netif);
